...
# Minimal runtime: tini (PID 1), supervisor, wget for binary fetch,
# psmisc/procps for pgrep used by healthcheck + TUI bridge detection,
# libc6:i386 because slmodemd is a 32-bit i386 binary.
...
# Expose ports
# 22 - SSH (Go TUI)
# 5060 - SIP (UDP, slmodem-sip-bridge default)
# 20000+ - RTP media (slmodem-sip-bridge SIP_LOCAL_RTP_PORT, default 20000)
